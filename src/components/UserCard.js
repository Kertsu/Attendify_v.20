        ...
        <View style={{ gap: SIZES.small }}>
            ...
            >
              <View style={[styles.avatarContainer]}>
                <Image
                  style={styles.avatar}
                  source={profile? {uri: profile}: require('../../assets/images/no_image.jpg')}
                />
              </View>
            ...
            {!isApproved && <View style={{alignItems:"flex-start"}}>
              <View style={{paddingHorizontal:10, borderRadius:SIZES.xxxSmall, backgroundColor:COLORS.bgPrimary, paddingVertical:5}}>
